                ...
                >
                  ...
                  <div className="p-5">
                    <div className="mb-3 flex items-start justify-between gap-3">
                      ...
                      <button type="button" onClick={() => { setOpenActionMenuId(null); setEditingItem(buildEditableItem(item)); }} aria-label={`Edit ${item.name}`} className="inline-flex min-h-11 shrink-0 items-center gap-2 rounded-lg border border-indigo-200 px-3 py-2 text-sm font-medium text-indigo-700 hover:bg-indigo-50"><Edit className="h-4 w-4" /> Edit</button>
<div className="relative">
                        <button
                          type="button"
